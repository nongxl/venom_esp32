...
public:
    ...
    void init();
    void update(float dt, const SkeletonSystem &skeleton, const PhysiologySystem &physiology, float look_x, float look_y, bool is_sleeping = false, bool is_stealth = false);
...
private:
    ...
    void updateSeedDynamics(float dt, const SkeletonSystem &skeleton, const PhysiologySystem &physiology, float look_x, float look_y, bool is_sleeping, bool is_stealth = false);
};
