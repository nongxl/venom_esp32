...
### 3. 🐛 小虫子生态与变色龙三模态进食 (Prey Ecology & Chameleon Predation)
- **生动的小虫子生态**：
  - **边缘爬虫 (Crawler)**：贴在屏幕四周玻璃边缘变速爬行，走走停停试探环境；
  - **空中飞虫 (Firefly/Fly)**：在空中快速扇翅以正弦轨迹变速飞舞，伴随呼吸荧光晕；
- **又凶又萌的白尖牙大嘴与粉红卷舌**：
  - 平时微闭露出 1~2 颗可爱小白尖牙；
  - 进食时裂开深红口腔，展现上下锐利白尖牙与粉红变色龙长卷舌！
- **三种完全不同的进食捕食模态**：
  1. 👅 **变色龙闪电卷舌 (Chameleon Tongue)**：0.12s 极速弹射粉红长舌，舌尖吸盘黏住虫子卷回口中吞食；
  2. 🐙 **触手抓捕塞入嘴中 (Tentacle Snatch)**：射出黑色爪盘触手抓住虫子扯回头部塞入口中；
  3. 💦 **喷射黏液定身爬食 (Slime Stalk)**：吐出黏液球定身封印虫子，毒液大步爬近一口吞下；
- **进食咀嚼与营养回补**：吞咽后伴随 3 次咔嚓咔嚓咀嚼动画、短促触觉微震动反馈、饱腹能量回补与压力释放！
...
| 交互动作 | 硬件操作 | 生物响应与反馈 |
| :--- | :--- | :--- |
| **观察毒液捕食小虫** | **屏幕随机出现小虫子** | 毒液眼球锁定虫子，轮番触发变色龙闪电卷舌、触手抓捕或喷射黏液进食 |
...
- `bug <fly|crawl>`：手动立即在屏幕中生成一只飞虫或爬虫供毒液捕食
